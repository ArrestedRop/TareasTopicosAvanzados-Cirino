"""GUIComponentsCohes.py
Inspirado por Liang:
por Cirino Silva Tovar
el: 31 de Agosto 2018

El ejercicio 5 consiste en aplicar ingenieria inversa a este codigo para que a
partir del programa se obtenga el disenyo del seudocodigo aplicando el enfoque
de sistemas e identificando los componentes que son contenedores y los que son
